...
//  ProgressDialog progressDialog = null;                          //~1A6tR~
    URunnableData progressDialog = null;                           //~1A6tR~
...
//      view = (TextView) mContentView.findViewById(R.id.device_info);//~1A65I~
        ...
        tvPeerStatus=(TextView)PlayoutView.findViewById(R.id.peer_status);//~1A84I~//~1A90I~
        tvPeerInfo=(TextView)PlayoutView.findViewById(R.id.peer_info);//~1A84R~//~1A90I~
...
//                      						WDA.getResourceString(R.string.ProgressDialogMsgConnectingNFC)+Pmacaddr,//~1A67I~//+1AbBR~
    ...
    {                                                              //~1A65I~
        boolean rc=false;   //no dismiss                           //~1A65I~
    //********************                                         //~1A65I~
    	if (Dump.Y) Dump.println("DeviceDetailFragment:disconnect");//~1A84I~//~1A90I~
      boolean noActiveSession=                                     //~1A89R~//~1A6tI~
		WDA.SWDA.unpairRequest();	//close if session alive       //~1A87R~//~1A6tI~
//                      ((DeviceActionListener) getActivity()).disconnect();//~1A65R~
//                      ((DeviceActionListener) WDA.getWDActivity()).disconnect();//~1A65R~//~1A6tR~
	  	if (noActiveSession)                                       //~1A89R~//~1A6tI~
		    doUnpair();                                            //~1A89R~//~1A6tI~
    	return rc;                                                 //~1A65I~
    }                                                              //~1A65I~
	//***********************************************************************************//~1A87I~//~1A6tI~
    public void doUnpair()                                         //~1A89R~//~1A6tI~
    {                                                              //~1A89R~//~1A6tI~
    	if (Dump.Y) Dump.println("DeviceDetailFragment:doUnpair"); //~1A89R~//~1A6tI~
    	((DeviceActionListener) WDA.getWDActivity()).disconnect(); //~1A89R~//~1A6tI~
    }                                                              //~1A89R~//~1A6tI~
	//***********************************************************************************//~1A65I~
//    @Override                                                    //~1A65R~
...
//      btnDisconnect.setVisibility(View.VISIBLE);                 //~1A65R~
    	WDA.SWDA.connected(info.isGroupOwner);                     //~1A84I~//~1A90I~
      }                                                            //~1A65I~
...
//          tv.setText(WDA.getResourceString(R.string.PeerDeviceName)+peerDevice);//~1A65R~//~1A84R~//~1A90I~
            tv.setText(peerDevice);                                //~1A84I~//~1A90I~
            String ip=IPConnection.getRemoteIPAddr(true/*return null if N/A*/);//~1A84R~//~1A90I~
            if (ip==null)                                          //~1A84I~//~1A90I~
            {                                                      //~1A84I~//~1A90I~
            	tvPeerStatus.setText(AG.resource.getString(R.string.DeviceConnected));  //paired//~1A84I~//~1A90I~
//              if (owner)                                         //~1A84I~//~1A8mR~//~1A90I~
                if (!owner)   //i'm client -->peer is server       //~1A8mI~//~1A90I~
            		tvPeerInfo.setText(AG.resource.getString(R.string.MyOwnerYes));//~1A84I~//~1A90I~
                else                                               //~1A84I~//~1A90I~
            		tvPeerInfo.setText(AG.resource.getString(R.string.MyOwnerNo));//~1A84I~//~1A90I~
            }                                                      //~1A84I~//~1A90I~
            else                                                   //~1A84I~//~1A90I~
            {                                                      //~1A84I~//~1A90I~
            	tvPeerStatus.setText(AG.resource.getString(R.string.IPInSession));//~1A84R~//~1A90I~
            	tvPeerInfo.setText(ip);                            //~1A84I~//~1A90I~
            }                                                      //~1A84I~//~1A90I~
...
//****************************************                         //~1A67I~
//  private ProgressDialog progressDialogShow(int Ptitleid,String Pmsg,boolean Pindeterminate,boolean Pcancelable)//~1A6tR~
    private URunnableData progressDialogShow(int Ptitleid,String Pmsg,boolean Pindeterminate,boolean Pcancelable)//~1A6tR~
    {                                                              //~1A67I~
