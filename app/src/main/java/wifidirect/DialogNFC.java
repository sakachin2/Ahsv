...
//1Abr 2015/06/17 NFC:colored background only when accept NFC tap. //~1AbrI~
...
//1Aac 2015/04/29 (Bug)only one session err NFC connection  on 2nd NFC button at accpter//~1AacI~
//                import Server was not wifidirect but jagoclient.partner//~1AacI~
...
//import jagoclient.partner.PartnerFrame;                          //~1A90R~
import wifidirect.PartnerFrame;                                    //~1A84I~//~1A90I~
//import jagoclient.partner.Server;                                //~1AacR~
import wifidirect.Server;                                          //~1AacI~
...
import com.Ahsv.awt.UButton;                                       //~5218I~
import com.Ahsv.awt.UTextView;                                     //~5218I~
...
//      showMsg(TEXTID_HELP);                                      //~5218I~//~1AbzR~
    ...
    {
//  	Intent intent = new Intent(Settings.ACTION_NFCSHARING_SETTINGS);//~1A6BR~
//  	Intent intent = new Intent(Settings.ACTION_WIRELESS_SETTINGS);//~1A6BI~//~1Ad3R~
//      AG.activity.startActivity(intent);                         //~1Ad3R~
    	DialogNFCSelect.callSettingsWiFi();  //NFC                 //~1Ad3I~
    }
	//***********************************************************************************//~1Ad3I~
    private void callSettingsNFC()                                 //~1Ad3I~
    {                                                              //~1Ad3I~
    	DialogNFCSelect.callSettings();    //NFC                   //~1Ad3R~
    }                                                              //~1Ad3I~
	//*************************************************************************
...
//      if (AG.activeSessionType!=0)                               //~1AbrI~//~1AbsR~
        if (swPaired)                                              //~1AbsR~
            tvMsg.textView.setBackgroundColor(Color.WHITE);        //~1AbrI~
        else                                                       //~1AbsI~
...
//      boolean rc=enableWiFi();                                   //~1A84R~//~1A90I~
        boolean rc=WDA.enableWiFi();                               //~1A84I~//~1A90I~
        swWifiEnable=rc;                                           //~1A84I~//~1A90I~
        if (!rc)
        	return;
        wifiActivity.registerReceiver();
    }
	//*************************************************************************
//    private boolean enableWiFi()                                 //~1A90R~
//    {                                                            //~1A90R~
//        boolean rc=true;                                         //~1A90R~
//    //**********************                                     //~1A90R~
//        WifiManager wm=(WifiManager) AG.context.getSystemService(Context.WIFI_SERVICE);//~1A90R~
//        if (!wm.isWifiEnabled())                                 //~1A90R~
//        {                                                        //~1A90R~
//            if (wm.setWifiEnabled(true))//success                //~1A90R~
//                AView.showToastLong(R.string.InfoWifiEnabled);   //~1A90R~
//            else                                                 //~1A90R~
//            {                                                    //~1A90R~
//                AView.showToastLong(R.string.ErrWifiEnable);     //~1A90R~
//                rc=false;                                        //~1A90R~
//            }                                                    //~1A90R~
//        }                                                        //~1A90R~
//        if (Dump.Y) Dump.println("enableWiFi rc="+rc);           //~1A90R~
//        swWifiEnable=rc;                                         //~1A90R~
//        return rc;                                               //~1A90R~
//    }                                                            //~1A90R~
	//*************************************************************************
	//*on MainThread
...
//  public void onPeersAvailable()                                //~5218I~//~1AbxR~
    ...
    {                                                              //~5218I~
        if (Dump.Y) Dump.println("DialogNFC:onPeersAvailable ctr="+Pctr+",swwaitingPeerDiscovery="+swWaitingPeerDiscovery+",swPairingRequester="+swPairingRequester+",swWaitingConnection="+swWaitingConnection);//~5218R~//~1AbxI~
...
//      PartnerFrame cf=new PartnerFrame(Global.resourceString("Connection_to_")+c.Name,false,IPConnection.NFC_CLIENT);//~1A6BI~//~1A84R~//~1A90I~
        PartnerFrame cf=new PartnerFrame(Global.resourceString("Connection_to_")+c.Name,false,PartnerFrame.NFC_CLIENT);//~1A84I~//~1A90I~
    ...
    {                                                              //~5218I~
//  	int n=Prop.getPreference(IPConnection.PKEY_SERVER_PORT,AG.DEFAULT_SERVER_PORT);//~5218I~//~1A84R~//~1A90I~
		int n=IPConnection.getPortNo();                            //~1A84R~//~1A90I~
		return n;                                                  //~5218I~
    }                                                              //~5218I~
    //******************************************                   //~5218I~
    ...
    {                                                              //~1A78I~
        NfcManager mgr=(NfcManager)AG.context.getSystemService(Context.NFC_SERVICE);//~1A78I~
