...
//import com.Ahsv.awt.GridLayout;                                  //~2C26R~//~v101R~//~1AbBR~
...
import android.widget.CheckBox;                                    //~1Af4I~

import com.Ahsv.ABT;                                              //~v101R~//~1AbBR~
...
import com.Ahsv.awt.Component;                                     //~1AbBR~
...
//  			(PhandoverType==DialogNFCSelect.NFCTYPE_BT_SECURE?R.string.Title_NFCBT_Secure:R.string.Title_NFCBT_InSecure),//~1Ab8I~//~1Af4R~
				R.string.Title_NFCBT_Init,                        //~1Af4M~
...
//      int initmsgid=AG.activeSessionType==0 ? TEXTID_INITIAL : TEXTID_CONNECTED;//~1AbhI~//~1Af8R~
        ...
        if (AG.activeSessionType!=0)	//connected status         //~1Af4I~
	    	cbSecureOption.setEnabled(false);                      //~1Af4R~
        displayDevice();                                           //~3202I~
...
//          }                                                        //~1A60I~//~1Ab8R~
        ...
        {                                                          //~3201I~
    		...
    		if (AG.RemoteDeviceName==null)	                       //~1Af7I~
        		connectButton.setEnabled(false);                   //~1Af7I~
        }                                                          //~3201I~
        else                                                       //~3201I~
        {                                                          //~3201I~
	...
	{                                                              //~2C26R~
        ...
        {                                                          //~3117I~
            ...
            {                                                      //~1AemI~
                ...
                if (o.equals(AG.resource.getString(STRING_ID_SETTING_NFC)))  //modal but no inputWait//~1AemI~
                {                                                  //~1AemI~
                    callSettingsNFC();                             //~1AemI~
                }                                                  //~1AemI~
                else                                               //~1AemI~
...
//                cancelDiscover();                                  //~3203R~//~1Ab8R~
            ...
            if (o.equals(AG.resource.getString(STRING_ID_SETTING)))  //modal but no inputWait//~1Ad3R~
            {                                                      //~1Ad3I~
	        	callSettings();                                    //~1Ad3I~
            }                                                      //~1Ad3I~
            else                                                   //~1Ad3I~
            if (o.equals(AG.resource.getString(STRING_ID_SETTING_NFC)))  //modal but no inputWait//~1Ad3R~
            {                                                      //~1Ad3I~
...
//      if (SdialogNFC==null)                                      //~1Ab8I~//~1Af2R~
    ...
    {                                                              //~1Ab8I~
            ...
            SdialogNFC.swSecure=SdialogNFC.getSecureOption();                 //~1Af4R~
    		SdialogNFC.setToPropSecureOption(SdialogNFC.swSecure);            //~1Af4R~
...
//          swSecure=opt.equals("1");                              //~1Ab8R~//~1AbmR~
            ...
            swSecure=getSecureOption(); //chjeckbox status at intent received//~1Af4R~
...
//        super(Pgf,                                               //~1Af1I~
//                (PhandoverType==DialogNFCSelect.NFCTYPE_BT_SECURE?R.string.Title_NFCBT_Secure:R.string.Title_NFCBT_InSecure),//~1Af1I~
//                (AG.layoutMdpi/*mdpi and height or width <=320*/ ? R.layout.dialognfcbt_mdpi : R.layout.dialognfcbt));//~1Af1I~
//        swSecure=PhandoverType==DialogNFCSelect.NFCTYPE_BT_SECURE;//~1Af1I~
        init();                                                    //~1Af1I~
//        tvRemoteDevice=(TextView)(findViewById(R.id.RemoteDevice));//~1Af1I~
//        tvMsg=(TextView)(findViewById(R.id.Msg));                //~1Af1I~
//        int initmsgid=AG.activeSessionType==0 ? TEXTID_INITIAL : TEXTID_CONNECTED;//~1Af1I~//~1Af2R~
//        showMsg(initmsgid);                                      //~1Af1I~
        displayDevice();                                           //~1Af1I~
...
//        new ButtonAction(this,0,ID_SETTING);                     //~1Af1I~
//        new ButtonAction(this,0,ID_SETTING_NFC);                 //~1Af1I~
//        nfcButtons=(LinearLayout)(findViewById(R.id.ButtonsNFCBT));//~1Af1I~
...
//        AG.aBTConnection=this;  //used when PartnerThread detected err//~1Af1I~
	...
	//**********************************************************************//~1Af4I~
    private boolean getSecureOption()                              //~1Af4I~
    {                                                              //~1Af4I~
    	boolean rc=cbSecureOption.isChecked();                     //~1Af4I~
        if (Dump.Y) Dump.println("DialogNFCBT.getSecureOption secure="+rc);//~1Af4I~
    	return rc;                                                 //~1Af4R~
    }                                                              //~1Af4I~
	//**********************************************************************//~1Af4I~
    public static boolean getSecureOptionFromProf()                //~1Af4R~
    {                                                              //~1Af4I~
    	boolean rc=Prop.getPreference(PKEY_BTSECURE_NFC,BTSECURE_DEFAULT_NFC)!=0;//~1Af4R~
        if (Dump.Y) Dump.println("DialogNFCBT.getSecureOptionFromProf secure="+rc);//~1Af4I~
        return rc;                                                 //~1Af4I~
    }                                                              //~1Af4I~
	//**********************************************************************//~1Af4I~
    private void setToPropSecureOption(boolean Pswsecure)          //~1Af4R~
    {                                                              //~1Af4I~
    	Prop.putPreference(PKEY_BTSECURE_NFC,Pswsecure?1:0);       //~1Af4R~
        if (Dump.Y) Dump.println("DialogNFCBT.setToPropSecureOption Pswsecure="+Pswsecure);//~1Af4R~
    }                                                              //~1Af4I~
}
