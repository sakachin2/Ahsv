...
//                  startActivity(new Intent(Settings.ACTION_WIRELESS_SETTINGS));//~1AbyR~
                    startActivity(new Intent(Settings.ACTION_WIFI_SETTINGS));//~1AbyI~
                } else {
...
//              Log.d(TAG, "Disconnect failed. Reason :" + reasonCode);//~1A65R~
        		if (Dump.Y) Dump.println("WiFiDirectActivity:disconnect removeGroup failure reason="+reasonCode);//~1A65I~//~1Ac0I~
...
//  private void notifyConnected(int Presult,String Pmsg)               //~1A6aR~//~1A6sR~
    ...
    {                                                              //~1A6aI~
      try                                                          //~1Ac0I~
      {                                                            //~1Ac0I~
    	if (Dump.Y) Dump.println("WiFiDirectActivity notifyConnected rc="+Presult);//~1A6aI~//~1Ac0I~
