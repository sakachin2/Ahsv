...
//          mAcceptThread.start();                                 //~@@@@R~
        ...
        if (Dump.Y) Dump.println("BTService SYNC:start() return swConnect="+AG.aBT.swConnect); //~v101I~//~1AbcI~
...
//        public AcceptThread(){this(false);}                        //~v101I~
                    ...
                    synchronized (BTService.this) {                //~@@@@R~
                        ...
                        case STATE_CONNECTING:
                            ...
                            if (acceptSecure)                      //~1A60I~
						        AView.showToastLong(AG.resource.getString(R.string.AcceptedBTSecureConnection,socket.getRemoteDevice().getName()));//~1A60R~
                            else                                   //~1A60I~
						        AView.showToastLong(AG.resource.getString(R.string.AcceptedBTInSecureConnection,socket.getRemoteDevice().getName()));//~1A60R~
...
//                BTService.this.start();                            //~@@@@R~//~@@@2R~
            ...
            if (swSecure)                                          //~1A60I~
				AView.showToastLong(AG.resource.getString(R.string.ConnectedBTSecureConnection,mmDevice.getName()));//~1A60R~
            else                                                   //~1A60I~
				AView.showToastLong(AG.resource.getString(R.string.ConnectedBTInSecureConnection,mmDevice.getName()));//~1A60R~
...
//***************************************************************************//~@@@@I~
    ...
    {                                                              //~@@@@I~
    	if (Dump.Y) Dump.println("acceptNext:"+mAcceptThread+",swNFC="+AG.aBT.swNFC+",secureNFC="+AG.aBT.swSecureNFC+",secureNonNfc="+AG.aBT.swSecureNonNFCAccept);     //~1A64I~//~1AbbR~//~1AbtI~
...
//***************************************************************************//~v101I~
    ...
    {                                                              //~v101I~
    	if (Dump.Y) Dump.println("acceptNextInSecure:"+mAcceptThread+",swNFC="+AG.aBT.swNFC+",secureNFC="+AG.aBT.swSecureNFC+",swSecureNonNFC="+AG.aBT.swSecureNonNFCAccept);//~1AbbI~//~1AbtR~//~1AbZI~
        if (AG.aBT.swNFC && AG.aBT.swSecureNFC)                    //~1AbbI~
        	return false;                                          //~1AbbI~
        if (!AG.aBT.swNFC && AG.aBT.swSecureNonNFCAccept)          //~1AbtI~
        	return false;                                          //~1AbtI~
