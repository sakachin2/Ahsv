...
//import com.Ahsv.awt.Viewer;                                      //~2C26R~
...
//        if (s.equals(Global.resourceString("Edit_Connection"))) //TellQuestion//~1314I~//~@@@@R~
//        {                                                          //~1314I~//~@@@@R~
//            modalToGetInput=false;                                 //~1405I~//~@@@@R~
//            if (AG.mainframeTag==0) //Cardpanel:ServerConnection   //~1318I~//~@@@@R~
//                layoutid=AG.dialogId_EditConnection;               //~1318R~//~@@@@R~
//            else                                                   //~1318I~//~@@@@R~
//                layoutid=AG.dialogId_EditPartner;                  //~1318I~//~@@@@R~
//        }                                                          //~1314I~//~@@@@R~
//        else                                                       //~1314I~//~@@@@R~
//        if (s.equals("FileDialog"))                                //~1330R~//~@@@@R~
//        {                                                          //~1326I~//~@@@@R~
//            layoutid=AG.dialogId_FileDialog;                       //~1403R~//~@@@@R~
//        }                                                          //~1326I~//~@@@@R~
//        else                                                       //~1326I~//~@@@@R~
//      if (s.equals(Global.resourceString("Help"))) //TellQuestion//~1327I~//~@@@@R~
//        if (s.equals(AG.resource.getString(R.string.Help))) //TellQuestion//~@@@@I~//~v101R~
//        {                                                          //~1327I~//~v101R~
//            modalToGetInput=false;                                 //~1327I~//~v101R~
//            layoutid=AG.dialogId_HelpDialog;                       //~1327I~//~v101R~
//        }                                                          //~1327I~//~v101R~
//        else                                                       //~1327I~//~v101R~
//        if (s.equals(Global.resourceString("Advanced_Options")))   //~1328I~//~v101R~
//        {                                                          //~1328I~//~v101R~
//            modalToGetInput=false;                                 //~1328I~//~v101R~
//            layoutid=AG.dialogId_AdvancedOptionEdit;               //~1328I~//~v101R~
//        }                                                          //~1328I~//~v101R~
//        else                                                       //~1328I~//~v101R~
//        if (s.equals(Global.resourceString("Function_Keys")))      //~1330R~//~@@@@R~
//        {                                                          //~1330I~//~@@@@R~
//            modalToGetInput=false;                                 //~1330I~//~@@@@R~
//            layoutid=AG.dialogId_FunctionKeys;                     //~1330I~//~@@@@R~
//        }                                                          //~1330I~//~@@@@R~
//        else                                                       //~1330I~//~@@@@R~
//        if (s.equals(Global.resourceString("Edit_Filter")))        //~1331I~//~@@@@R~
//        {                                                          //~1331I~//~@@@@R~
//            modalToGetInput=false;                                 //~1331I~//~@@@@R~
//            layoutid=AG.dialogId_EditFilter;                       //~1331I~//~@@@@R~
//        }                                                          //~1331I~//~@@@@R~
//        else                                                       //~1331I~//~@@@@R~
//        if (s.equals(Global.resourceString("Edit_Buttons")))       //~1331I~//~@@@@R~
//        {                                                          //~1331I~//~@@@@R~
//            modalToGetInput=false;                                 //~1331I~//~@@@@R~
//            layoutid=AG.dialogId_EditButtons;                      //~1331I~//~@@@@R~
//        }                                                          //~1331I~//~@@@@R~
//        else                                                       //~1331I~//~@@@@R~
//        if (s.equals(Global.resourceString("Relay_Server")))       //~1331I~//~@@@@R~
//        {                                                          //~1331I~//~@@@@R~
//            modalToGetInput=false;                                 //~1331I~//~@@@@R~
//            layoutid=AG.dialogId_RelayServer;                      //~1331R~//~@@@@R~
//        }                                                          //~1331I~//~@@@@R~
//        else                                                       //~1331I~//~@@@@R~
...
//        if (s.equals(Global.resourceString("Edit_Color")))         //~1331I~//~@@@@R~
//        {                                                          //~1331I~//~@@@@R~
//            modalToGetInput=false;                                 //~1331I~//~@@@@R~
//            if (AG.isMainFrame(parentFrame))                       //~1331I~//~@@@@R~
//                layoutid=AG.dialogId_GlobalGray;                   //~1331I~//~@@@@R~
//            else                                                   //~1331I~//~@@@@R~
//                layoutid=AG.dialogId_ColorEdit;                    //~1331R~//~@@@@R~
//        }                                                          //~1331I~//~@@@@R~
//        else                                                       //~1331I~//~@@@@R~
//        if (s.equals(Global.resourceString("Mail_Game")))          //~1404I~//~@@@@R~
//        {                                                          //~1404I~//~@@@@R~
//            modalToGetInput=false;                                 //~1404I~//~@@@@R~
//            layoutid=AG.dialogId_MailDialog;                       //~1404I~//~@@@@R~
//        }                                                          //~1404I~//~@@@@R~
//        else                                                       //~1404I~//~@@@@R~
//        if (s.equals(Global.resourceString("Play_Go")))            //~1404I~//~@@@@R~
//        {                                                          //~1404I~//~@@@@R~
//            modalToGetInput=false;                                 //~1404I~//~@@@@R~
//            layoutid=AG.dialogId_GMPWait;                          //~1404I~//~@@@@R~
//        }                                                          //~1404I~//~@@@@R~
//        else                                                       //~1404I~//~@@@@R~
...
//        if (s.equals(Global.resourceString("Game_Setup")))         //~1405I~//~@@@@R~
//        {                                                          //~1405I~//~@@@@R~
//            modalToGetInput=false;                                 //~1405I~//~@@@@R~
//            if (windowlistener!=null && windowlistener instanceof BoardQuestion)    //BoardQuestion or GameQuestion for "Game_setup";//~1405I~//~@@@@R~
//                layoutid=AG.dialogId_BoardQuestion;                   //~1405M~//~@@@@R~
//            else                                                   //~1405I~//~@@@@R~
//                layoutid=AG.dialogId_GameQuestion;                    //~1405M~//~@@@@R~
//                                                    //~1405M~    //~@@@@R~
//        }                                                          //~1405I~//~@@@@R~
//        else                                                       //~1405I~//~@@@@R~
...
//        if (s.equals(Global.resourceString("Text_Mark")))          //~1405I~//~@@@@R~
//        {                                                          //~1405I~//~@@@@R~
//            modalToGetInput=false;                                 //~1405I~//~@@@@R~
//            layoutid=AG.dialogId_TextMark;                         //~1405I~//~@@@@R~
//        }                                                          //~1405I~//~@@@@R~
//        else                                                       //~1405I~//~@@@@R~
        if (false                                                  //~1327R~
...
//*****************                                                //~1124I~//~1311M~
	...
	//************                                                 //~1215I~//~1311M~
        ...
        {                                                          //~1A40I~
          if (customTitle!=null)                                   //~1A40I~
            setCustomTitle(Pdata.text);                            //~1A40I~
          else                                                     //~1A40I~
        	androidDialog.setTitle(Pdata.text);	//new title                                    //~1214I~//~1309R~//~1311I~//~1325R~
        }                                                          //~1A40I~
    }                                                              //~1214I~//~1311M~
//*on Ui Thread **************                                     //~1A40I~
    private void setCustomTitle(String Ptitle)                     //~1A40I~
    {                                                              //~1A40I~
		customTitle.setText(Ptitle);                               //~1A40I~
...
//*****************************************************************************************//~1A68I~
	public void setWindowSize(int Pratew,int Prateh,boolean PminWH/*apply for min(Width,Height)*/)//~1A68R~
    {                                                              //~1A68I~
    	int ww,hh,scrw,scrh;                                       //~1A68R~
        ...
        if (Pratew==0)                                             //~1A68I~
        	...
        	ww=scrw*Math.min(Pratew,100)/100;                      //~1A68R~
        if (Prateh==-1)                                            //~1A68I~
        ...
        if (Prateh==0)                                             //~1A68I~
        	...
        	hh=scrh*Math.min(Prateh,100)/100;                      //~1A68R~
        if (Dump.Y) Dump.println("Dialog:setWindowSize parm w="+Pratew+",h="+Prateh+",pix w="+ww+",h="+hh+",scr w="+AG.scrWidth+",h="+AG.scrHeight+",PminWH="+PminWH);//~1A68R~
