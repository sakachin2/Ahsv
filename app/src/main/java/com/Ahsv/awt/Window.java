//*CID://+@@@2R~:                             update#=   15;       //~@@@@I~//~@@@2R~
package com.Ahsv.awt;                                                //~1108R~//~1109R~//~@@@@R~
...
//*****************************************************            //~1415I~
    ...
    {                                                              //~1415I~
    	if (Dump.C) Dump.println("Window:recyclePrepare Bitmap="+Pbitmap.toString());//~1506R~//~@@@2R~
    ...
    {                                                              //~1415I~
    	if (Dump.C) Dump.println("Window:recycleBitmap");          //~1506R~//~@@@2R~
    	if (recycleBitmaps==null)                                  //~1415I~
        	return;                                                //~1415I~
        int ctr=recycleBitmaps.size();                             //~1415I~
    	if (Dump.C) Dump.println("Window:recycleBitmap ctr="+ctr); //~1506R~//~@@@2R~
    	if (ctr==0)                                                //~1415I~
        	return;                                                //~1415I~
        ...
        {                                                          //~1415I~
            ...
            {                                                      //~1415I~
    			...
    			if (Dump.C) Dump.println("Window:recycleBitmap ii="+ii+",Bitmap="+bitmap.toString());//~1506R~//~@@@2R~
            }                                                      //~1415I~
        }                                                          //~1415I~
...
//*****************************************************            //~@@@2I~
    ...
    //*******************                                          //~@@@2I~
    	if (Dump.C) Dump.println("Window:recycleMyPrepare Bitmap="+Pbitmap.toString());//+@@@2R~
        stack=Pstack;                                              //~@@@2I~
        if (stack==null)                                           //~@@@2I~
    ...
    {                                                              //~@@@2I~
    	if (Dump.C) Dump.println("Window:recycleMyBitmapStack");   //~@@@2R~
    	if (Pstack==null)                                          //~@@@2I~
        	return;                                                //~@@@2I~
        int ctr=Pstack.size();                                     //~@@@2I~
    	if (Dump.C) Dump.println("Window:recycleMyBitmapStack ctr="+ctr);//~@@@2R~
    	if (ctr==0)                                                //~@@@2I~
        	return;                                                //~@@@2I~
        ...
        {                                                          //~@@@2I~
            ...
            {                                                      //~@@@2I~
            	bitmap.recycle();                                  //~@@@2I~
    			if (Dump.C) Dump.println("Window:recycleMyBitmapStack ii="+ii+",Bitmap="+bitmap.toString());//~@@@2R~
            }                                                      //~@@@2I~
        }                                                          //~@@@2I~
        Pstack.clear();                                            //~@@@2I~
    }                                                              //~@@@2I~
//*****************************************************            //~@@@@I~
    ...
    {                                                              //~@@@@I~
        ...
        {                                                          //~@@@@I~
            Pbitmap.recycle();                                     //~@@@@I~
    		if (Dump.C) Dump.println("Window:recycleBitmapNow Bitmap="+Pbitmap.toString());//~@@@@I~//~@@@2R~
        }                                                          //~@@@@I~
    }                                                              //~@@@@I~
}//class                                                           //~1415R~
