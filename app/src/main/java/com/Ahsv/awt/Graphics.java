...
{                                                                  //~1112I~
	...
	private com.Ahsv.awt.Canvas ajagocCanvas;   //android canvas:awt graphics//~1421R~//~@@@@R~
...
//***************	                                               //~1421I~
    public void setCanvas(com.Ahsv.awt.Canvas PajagocCanvas) //~1421R~//~@@@@R~
    {                                                              //~1421I~
...
//**************                                                   //~1117I~
    ...
    {                                                              //~1117I~
    	if (Dump.C) Dump.println("Graphics.drawLine androidCanvas="+androidCanvas.toString());//~@@@@I~//~1A6AR~
...
//**************                                                   //~1117I~
    ...
    {                                                              //~1117I~
    	...
    	if (Dump.C) Dump.println("Graphics.drawRect x="+Px+",y="+Py+",w="+Pw+"h="+Ph);//~@@@@I~//~1A6AR~
...
//**************                                                   //~@@@@I~
    ...
    {                                                              //~@@@@I~
    	...
    	if (Dump.C) Dump.println("Graphics.drawRect stroke x="+Px+",y="+Py+",w="+Pw+"h="+Ph);//~@@@@I~//~1A6AR~
...
//************** for rene.lister.ListerPanel                       //~1215I~
    ...
    {                                                              //~1215I~
    	return com.Ahsv.awt.Canvas.getFontMetrics(Pfont);                       //~1215I~//~@@@@R~
	}                                                              //~1215I~
                                //~1215I~
    public FontMetrics getFontMetrics()                            //~1215I~
    {                                                              //~1215I~
    	return com.Ahsv.awt.Canvas.getFontMetrics(font);         //~1215I~//~@@@@R~
	}                                                              //~1215I~
//********************************                                 //~1301R~
