...
//              AG.resource.getString(R.string.Cancel),            //~@@@2I~//~1A2jR~
                AG.resource.getString(R.string.Close),             //~1A2jI~
...
//****************************************                         //~1A2jI~
    ...
    public void showProgDlgUI(ProgDlgI Pdlgi,boolean Pcancelcb,int Ptitleid,String Pmsg,boolean Pcancelable)//~1A2jI~
    {                                                              //~1A2jI~
...
//===============================================================================//~@@@2I~//~1A2jI~
    ...
    {                                                              //~@@@2I~//~1A2jI~
        ...
        {                                                          //~1A2jI~
			showProgDlgUI(pd.mtDlgI,pd.mtCancelCB,pd.mtTitleid,pd.mtMsg,pd.mtCancelable);//~1A2jI~
        }                                                          //~1A2jI~
    }                                                              //~@@@2I~//~1A2jI~
