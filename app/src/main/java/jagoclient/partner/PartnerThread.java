...
import com.Ahsv.rene.viewer.Viewer;                              //~1318I~//~2C26R~
...
//  	{	while (true)                                           //~@@@9R~
    	{                                                          //~@@@9I~
            if (Dump.Y) Dump.println("PartnerThread=====started="+this.toString());//~@@@9I~
    	 	while (true)                                           //~@@@9I~
			{                                                      //~3207R~
				if (Dump.Y) Dump.println("PartnerThread readline");//~3207I~
...
//          new Message(PF,Global.resourceString("_____Connection_Error"));//~3201R~
        ...
        if (Dump.Y) Dump.println("PartnerThread===== Run Terminated");  //~3120I~//~@@@9R~
