...
//      }                                                          //~3206I~//~1A6iR~
//      pairedList=AG.aBT.getPairDeviceList();                     //~1AbTI~
...
//      deleteConnectedDevice(name,idx);                           //~1AbSR~//~1AbTR~
    ...
    {                                                              //~1AbtI~
    	boolean rc=ABT.startListenNonNFC(Psecure);                 //~1AbtI~
        return rc;                                                 //~1AbtI~
    }                                                              //~1AbtI~
    //******************************************                   //~1A6fR~
...
//    }                                                              //~1AbuI~//~1AbUR~
    ...
    {                                                              //~1AbuI~
    	swSecure=getSecureOption();                                //~1AbuI~
    	Prop.putPreference(PKEY_BTSECURE,swSecure?1:0);            //~1AbuI~
    }                                                              //~1AbuI~
    //***********************************************************************//~1AbvI~//~1AbuI~
...
//      public int search(String Pname)                            //~1AbUI~//~1Ah9R~
    ...
    {                                                              //~1Ac5I~
        ...
        Alert.simpleAlertDialog(ai,R.string.Title_Bluetooth,R.string.WarningBTNotDiscoverable,//~1Ac5I~
    ...
    {                                                              //~1Af1I~
        ...
        try                                                        //~1Af1I~
        {                                                          //~1Af1I~
            if (AG.aBTConnection!=null && AG.aBTConnection.androidDialog.isShowing())//~1Af1R~
            {                                                      //~1Af1R~
                BluetoothConnection btc=AG.aBTConnection;          //~1Af1R~
                btc.runRenewal();                                  //~1Af1R~
            }                                                      //~1Af1R~
        }                                                          //~1Af1I~
    ...
    {                                                              //~1Af1I~
        ...
        URunnableI ur=new URunnableI()                             //~1Af1R~
								{                                  //~1Af1I~
        ...
        URunnable.setRunFuncDirect(ur,this/*parm obj*/,0/*parm int*/);//widthout delay//~1Af1R~
    }                                                              //~1Af1I~
    //******************************************                   //~1Af1I~
    //*on MainThread                                               //~1Af1I~
    //******************************************                   //~1Af1I~
...
//        AG.aBTConnection=this;  //used when PartnerThread detected err//~1Af1I~
    ...
    //************************                                     //~1Af3I~
        ...
        {                                                          //~1Af3I~
            ...
            discoverableButton.setEnabled(false);                  //~1Af3R~
        }                                                          //~1Af3I~
        else                                                       //~1Af3I~
        {                                                          //~1Af3I~
        	dev=AG.resource.getString(R.string.StatusNotDiscoverable);//~1Af3R~
            discoverableButton.setEnabled(true);                   //~1Af3R~
        }                                                          //~1Af3I~
        v.setText(dev);                                            //~1Af3I~
    }                                                              //~1Af3I~
}
