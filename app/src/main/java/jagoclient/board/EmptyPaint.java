...
//1020 2013/02/15 NPE (Dump.println)                               //~v102I~
//*@@@1 20110514                                                   //~@@@1I~
...
import com.Ahsv.jagoclient.board.EmptyIO;                          //~@@@1R~
import com.Ahsv.awt.Color;                                         //~@@@1R~
import com.Ahsv.awt.ColorModel;                                    //~@@@1R~
import com.Ahsv.awt.Component;                                     //~@@@1R~
import com.Ahsv.awt.Image;                                         //~@@@1R~
import com.Ahsv.awt.ImageObserver;                                 //~@@@1R~
import com.Ahsv.awt.MemoryImageSource;                             //~@@@1R~
...
{	Board B;
	...
	{                                                              //~1513R~
      ...
      {                                                            //~1B0gI~//~1Ad8I~
		Dump.println(me,"EmptyPaint:createwood");                  //~1B0gI~//~1Ad8I~
        AView.memoryShortage("EmptyPaint:createwood");         //~1B0gI~//~1Ad8I~
      }                                                            //~1B0gI~//~1Ad8I~
...
//  	if (Dump.Y) Dump.println("EmptyPaint createwood static="+newSImage.toString()+",shadow="+newSSImage.toString());//~@@@1R~//~v102R~
    	if (Dump.Y) Dump.println("EmptyPaint createwood static="+newSImage.toString());//~v102I~
        newSSImage=null;                                           //+1Ad9I~
        newSImage=null;                                            //+1Ad9I~
//  	StaticShadowImage=null; //do at Board                      //+1Ad9I~
//  	StaticImage=null;       //do at Board                      //+1Ad9I~
...
//      boolean shadows=true; 	//by Board.trywood                 //~@@@1I~//~@@@2R~
      ...
      {                                                            //~1B0gI~//~1Ad8I~
		Dump.println(me,"EmptyPaint:haveImage");                   //~1B0gI~//~1Ad8I~
        AView.memoryShortage("EmptyPaint:load");               //~1B0gI~//~1Ad8I~
      }                                                            //~1B0gI~//~1Ad8I~
